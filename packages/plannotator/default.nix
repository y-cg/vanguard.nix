...
let
  ...
  sources = {
    aarch64-darwin = {
      arch = "darwin-arm64";
      hash = "sha256-eUIES4zQSa37LViBLwIYYdHzoDUa0OHMWVZSVipmJRw=";
    };
    x86_64-darwin = {
      arch = "darwin-x64";
      hash = "sha256-LHNXyGRhR40me8FFUIpxwsn+942px7nagqNviAh/P7U=";
    };
    aarch64-linux = {
      arch = "linux-arm64";
      hash = "sha256-hGCsC4oPusSSg1w2S9JNLg8N3XFwn++BF1nFEI0y21I=";
    };
    x86_64-linux = {
      arch = "linux-x64";
      hash = "sha256-1zasKOCX7wziOo6qdvfP66VZh4ZAauc8P2F7LjG7nEA=";
    };
  };
  source =
